        ...
        <nav className="bg-white shadow-md fixed top-0 left-0 z-50 w-full">
            <div className="container mx-auto px-4 py-2 flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-8">
                    <a href="#" className="hover:bg-red-400 hover:duration-700 hover:text-white rounded-md px-3 py-2 text-sm font-xl font-bold">Home</a>
                    <a href="#" className="hover:bg-red-400 hover:duration-700 hover:text-white rounded-md px-3 py-2 text-sm font-xl font-bold">Contact</a>
                    <a href="#" className="hover:bg-red-400 hover:duration-700 hover:text-white rounded-md px-3 py-2 text-sm font-xl font-bold">About</a>
                    <a href="#" className="hover:bg-red-400 hover:duration-700 hover:text-white rounded-md px-3 py-2 text-sm font-xl font-bold">Sign Up</a>
                </div>
